 ...
 * @author 게임용 PC1
 */
public class ComputerSet extends StaticEntity{

    public ComputerSet(Handler handler, float x, float y) {
        super(handler, new Rectangle(10, 50, 180, 80), x, y, Tile.TILEWIDTH * 2 , Tile.TILEHEIGHT * 2);
    }
